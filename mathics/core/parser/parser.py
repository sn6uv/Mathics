...
class Parser(object):
    ...
    def b_SuperscriptBox(self, box1, token, p):
        q = right_binary_ops['SuperscriptBox']
        if q < p:
            return None
        if box1 is None:
            box1 = String('')
    ...
    def b_SubscriptBox(self, box1, token, p):
        q = right_binary_ops['SubscriptBox']
        if q < p:
            return None
        if box1 is None:
            box1 = String('')
    ...
    def b_UnderscriptBox(self, box1, token, p):
        q = right_binary_ops['UnderscriptBox']
        if q < p:
            return None
        if box1 is None:
            box1 = String('')
    ...
    def b_OverscriptBox(self, box1, token, p):
        q = right_binary_ops['OverscriptBox']
        if q < p:
            return None
        if box1 is None:
            box1 = String('')
